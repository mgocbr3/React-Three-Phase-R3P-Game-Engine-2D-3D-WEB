...
export const getVisibleDockPanelIds = (
  dockOrder: readonly EditorPanelId[],
  panels: Record<EditorPanelId, boolean>,
  isRuntimePreview: boolean,
): EditorPanelId[] => (
  isRuntimePreview ? ['viewport'] : dockOrder.filter((id) => panels[id])
);
