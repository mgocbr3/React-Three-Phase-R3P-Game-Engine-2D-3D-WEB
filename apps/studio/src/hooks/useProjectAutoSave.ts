...
import { saveGameData, createProject } from '@/services/projectService';
...
import { saveProjectVersion, hasSignificantChanges } from '@/services/projectVersioning';
import { detectConflict, resolveConflict, notifyPlatformOfResolution, type ConflictInfo, type ConflictResolutionStrategy } from '@/services/conflictResolution';
