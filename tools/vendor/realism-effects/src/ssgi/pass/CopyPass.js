...
export class CopyPass extends Pass {
	...
	constructor(textureCount = 1) {
		...
		// Three.js 0.162+: WebGLMultipleRenderTargets -> WebGLRenderTarget{count}.
		// We start with count:1 and setTextureCount() can grow `.textures[]`.
		this.renderTarget = new WebGLRenderTarget(1, 1, { depthBuffer: false, count: 1 })
