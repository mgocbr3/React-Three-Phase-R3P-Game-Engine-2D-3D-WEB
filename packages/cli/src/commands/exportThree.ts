...
const buildMainJsSource = (assetSourceBase: string): string => {
  ...
  return [
    ...
    '  postProcessing: {',
    '    enabled: true, toneMapping: "aces", toneMappingExposure: 1.0,',
    '    bloom: true, bloomIntensity: 0.18, bloomThreshold: 0.9, bloomRadius: 0.24,',
    '    colorGrading: true, contrast: 0.04, saturation: 0.02,',
    '  },',
    '};',
    '',
    '(async () => {',
